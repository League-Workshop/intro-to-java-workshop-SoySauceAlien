...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("lettuce maze.jpg"));
	...
	if(mouseColor==background) 
		...
		int endcolor=-13369600;
		if(mouseColor==endcolor){
			JOptionPane.showMessageDialog(null, "congratssssssssssssssssssss");
			System.exit(0);
		}
